...
for l in range(-1,fenotipos):
      if (l==-1):
              ...
              iteracionesm2, Bponderadorm2, vprediccionm2, error_prediccionm2, Rsquarem2, lognullm2, logmreducpm2, logverofm2, scorefm2, pseudorsquaredm2, llrfm2, llrf_pvaluem2, effect_marginalm2, Desv_finalm2, Tfinalm2, P_valuem2, tcortem2, testm2, pvaluem2, tcortepspecialm2, testpspecialm2, pvaluepspecialm2 = emoneProbit.emProbit(Y2, X, maxiter, error, perturbation, alpha, delta_grid, ipower, p_special_test);
